...
def signup():
    if request.method == 'POST':
        ...
        connection = pymysql.connect(host='localhost', user='root', password='', database='Elijah_Fungo')
...
def addProducts():
    if request.method== 'POST':
        ...
        # connection to database
        connection = pymysql.connect(host='localhost',password='',user='root',database='Elijah_Fungo')
